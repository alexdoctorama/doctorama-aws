...
import DoctorClinicalHistory from "./client/components/doctors/dashboard/DoctorClinicalHistory";
import PsychologistClinicalHistory from "./client/components/doctors/dashboard/PsychologistClinicalHistory";
import NutritionistClinicalHistory from "./client/components/doctors/dashboard/NutritionistClinicalHistory";
        ...
        {url === "admin" ? (
          ...
          <div>
            <Switch>
              ...
              {/* home */}
              <Route path="/index-2" exact component={HomeTwelve} />
              <Route path="/index" exact component={HomeTwelve} />
              <Route path="/homeslider1" exact component={HomeSlider1} />
              <Route path="/index-2" exact component={HomeTwelve} />
              <Route path="/index-3" exact component={HomeTwelve} />
              <Route path="/homeslider2" exact component={HomeSlider2} />
              <Route path="/index-5" exact component={HomeTwelve} />
              <Route path="/index-8" exact component={HomeTwelve} />

              <Route path="/index-6" exact component={HomeTwelve} />
              <Route path="/index-7" exact component={HomeTwelve} />
              <Route path="/index-4" exact component={HomeTwelve} />
              <Route path="/index-9" exact component={HomeTwelve} />
              <Route path="/index-10" exact component={HomeTwelve} />
              <Route path="/home11" exact component={HomeTwelve} />
              <Route path="/index-11" exact component={HomeTwelve} />
              <Route path="/index-12" exact component={HomeTwelve} />
              <Route path="/home12" exact component={HomeTwelve} />
              <Route path="/home13" exact component={HomeTwelve} />
              <Route path="/home14" exact component={HomeTwelve} />
              ...
              />
              <Route path="/doctorclinicalhistory" exact component={DoctorClinicalHistory} />
              <Route path="/psychologistclinicalHistory" exact component={PsychologistClinicalHistory} />
              <Route path="/nutritionistclinicalhistory" exact component={NutritionistClinicalHistory} />

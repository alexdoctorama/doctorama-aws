...
const PsychologistClinicalHistory = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`http://localhost:8080/psychologistclinicalhistory?psychologistClinicalHistoryUuid=${clinicalHistoryUuid}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.post('http://localhost:8080/psychologistclinicalhistory', flattenedData);
